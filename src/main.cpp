...
int main(int argc, char* argv[]) {
  ...
  //done for easy local testing
	//string in_file_name_ = "../VS_Project_2.1/data/obj_pose-laser-radar-synthetic-input.txt";
  ifstream in_file_(in_file_name_.c_str(), ifstream::in);

  string out_file_name_ = argv[2];
  //done for easy local testing
	//string out_file_name_ = "../VS_Project_2.1/data/output.txt";
